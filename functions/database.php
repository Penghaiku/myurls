...
class MySQLDatabase {
    ...
    private $host = "127.0.0.1"; //the host
    private $db_user = "GTSWDJKNDPnN3SeZ";  //Your username
    private $pass = "GTSWDJKNDPnN3SeZ";  // Your password
    private $dbase = "GTSWDJKNDPnN3SeZ"; // database name
    private $connection;
